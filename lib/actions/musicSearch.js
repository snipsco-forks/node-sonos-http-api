...
{   /// This function actually performs the search
  logger.debug(`Search service : ${service}, type: ${type}, term: ${term}`)
  ...
  // This is antho's specific approach ... 
  ...
  if (term.indexOf(':') > -1) {
    ...
    logger.debug(`[DEBUG][MusicSearch.js] artist:${artist}, track:${track}, album:${album}`);
    newTerm = serviceDef.term(type, term, artist, album, track);
    logger.debug(`[DEBUG][MusicSearch.js] newTerm:${newTerm}`);

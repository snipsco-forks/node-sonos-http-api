...
const deezerDef = {
  country:   '',
  search:    {
               album:   'https://api.deezer.com/search?limit=1&q=',  //'https://api.deezer.com/search/album/?limit=1&q=',
               song:    'https://api.deezer.com/search?limit=50&q=',
               station: 'https://api.deezer.com/search?limit=1&q=artist:', 
               artist:  'https://api.deezer.com/search/?limit=50&q=',
               playlist:  'https://api.deezer.com/search/?limit=50&q='
             },
  metastart: {
               album:   '0004006calbum-',
               song:    '00032020tr%3a',
...
'artist:"massive attack":album:"prout"'
...
function getSearchTerm(type, term, artist, album, track) {
  ...
  var results = keys.map((value, idx, arr) => `${value}:${values[idx]}`)
